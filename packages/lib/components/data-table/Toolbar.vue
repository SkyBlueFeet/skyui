  ...
  <div class="table-toolbar level">
    <div class="level-left">
      <div class="level-item" v-if="hasRefresh">
        <a class="button is-primary" @click="handleRefresh"
          ...
          <div slot="content">
            ...
            <menus>
              <menu-item
                ...
                :click="handleColumnControl.bind(this, index)"
                >{{ column.label }}</menu-item
              >
            </menus>
          </div>
        </dropdown>
...
export default {
  ...
  methods: {
    ...
    handleColumnControl(index) {
      this.$parent.columns[index].visible = !this.$parent.columns[index]
        .visible;
      this.$parent.columns[index].isShowIcon = this.$parent.columns[index]
        .visible
        ? "check"
        : "remove";
    }
