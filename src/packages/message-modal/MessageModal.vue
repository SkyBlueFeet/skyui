<template>
  <transition name="fade">
    <div
      class="modal modal-confirm align-baseline is-active borderless"
      v-show="isShow"
    >
      <div
      ...
      <transition :name="transition">
        <div class="modal-card" :style="modalWidth" v-show="isShow">
          ...
          <footer class="modal-card-foot" v-if="showFooter">
            <slot name="footer">
              <a class="button" @click="handleCancel" v-if="showCancel">{{
                cancelText
              }}</a>
              <a
...
<script>
import ModalMixin from "../../minixs/ModalMixin";
